...
class OrganizationsController < ApplicationController
  ...
  before_action :allowed_to_invite?, only: %i[invite]
  ...
  def create_invite
    ...
    if invite.errors.empty?
      ...
      redirect_on_invite(org_invite_path, :danger, invite.errors.full_messages.join(', '))
    end
  end
  ...
  def invite_data
    {
        ...
        accept_path: org_accept_invite_path(invite_token: ''),
